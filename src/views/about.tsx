...
export default function About(): JSX.Element {
    return (
        <div>
            <section className="text-center my-16" id="about-section">
            ...
            <section className="text-center my-8" id="contact-section">
                <SectionHeaders subHeader={'Don\'t hesitate'} mainHeader={'Contact us'}/>
                <div className="mt-8">
                    <a className="text-4xl underline text-gray-500" href="tel:+94766123678">
                        +94 766 123 678
                    </a>
                </div>
            </section>
